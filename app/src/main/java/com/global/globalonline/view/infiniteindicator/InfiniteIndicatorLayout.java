package com.global.globalonline.view.infiniteindicator;
...
import com.global.globalonline.view.infiniteindicator.indicator.PageIndicator;
import com.global.globalonline.view.infiniteindicator.indicator.RecyleAdapter;
import com.global.globalonline.view.infiniteindicator.jakewharton.salvage.RecyclingPagerAdapter;
...
public class InfiniteIndicatorLayout extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
    ...
    public RecyleAdapter mRecyleAdapter;
...
//            mViewPager.setCurrentItem(1);
    ...
    public void initFirstPage(int postion) {
        if (isInfinite && mRecyleAdapter.getRealCount() > 1) {
            mViewPager.setCurrentItem(mRecyleAdapter.getRealCount() * 50+postion);
        } else {
            setInfinite(false);
...
//            mViewPager.setCurrentItem(1);
    ...
    public void setIndicatorPosition(IndicatorPosition presentIndicator,int postion) {
        PageIndicator pagerIndicator = (PageIndicator) findViewById(presentIndicator.getResourceId());
        setCustomIndicator(pagerIndicator, postion);
    }
...
//        startAutoScroll();
    ...
    public void setCustomIndicator(PageIndicator indicator,int postion) {
//        initFirstPage(postion);
        mIndicator = indicator;
        mIndicator.setViewPager(mViewPager);
        mIndicator.setCurrentItem(postion);
//        startAutoScroll();
    }
    ...
    public void setCurrentItem(final int postion) {
        if(mViewPager!=null&&mRecyleAdapter!=null&&mRecyleAdapter.getRealCount() <= postion){
//            setInfinite(false);
...
//            mRecyleAdapter.notifyDataSetChanged();
    ...
    public void viewOnPageChangeListener(OnPageChangeListener pageChangeListener) {
